# Morphe Python Types Plugin

A Morphe compilation plugin that generates Python code with Pydantic models. Created using the morphe-types-template in ~25 minutes!
